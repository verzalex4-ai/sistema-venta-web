...
<ul class="navbar-nav" id="sidebar-wrapper">
    ...
    <li class="nav-item">
        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'productos.php' ? 'active' : ''; ?>" href="../pages/productos.php" style="position: relative;">
            <i class="fas fa-fw fa-box"></i><span>Productos</span>
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'categorias.php' ? 'active' : ''; ?>" href="../pages/categorias.php">
    ...
    <li class="nav-item">
        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'clientes.php' ? 'active' : ''; ?>" href="../pages/clientes.php">
    ...
    <li class="nav-item">
        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'proveedores.php' ? 'active' : ''; ?>" href="../pages/proveedores.php">
    ...
    <li class="nav-item">
        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'ventas.php' ? 'active' : ''; ?>" href="../pages/ventas.php">
    ...
    <li class="nav-item">
        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'facturas.php' ? 'active' : ''; ?>" href="../pages/facturas.php">
    ...
    <li class="nav-item">
        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'caja.php' ? 'active' : ''; ?>" href="../pages/caja.php">
    ...
    <li class="nav-item">
        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'cuentas_corrientes.php' ? 'active' : ''; ?>" href="../pages/cuentas_corrientes.php">
    ...
    <hr class="sidebar-divider" style="border-color: rgba(255,255,255,.2)">
    <li class="nav-item">
        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'reportes.php' ? 'active' : ''; ?>" href="../pages/reportes.php">
    ...
    <?php if (es_admin()): ?>
        ...
        <li class="nav-item">
            <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'usuarios.php' ? 'active' : ''; ?>" href="../pages/usuarios.php">
