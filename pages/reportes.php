...
$sql_total_ingresos = "SELECT COALESCE(SUM(total), 0) as ingresos FROM ventas WHERE estado='completada'";
$total_ingresos = $conn->query($sql_total_ingresos)->fetch_assoc()['ingresos'];
...
$sql_ventas_categoria = "SELECT c.nombre, COALESCE(SUM(dv.subtotal), 0) as total
                         FROM detalle_ventas dv
                         INNER JOIN productos p ON dv.producto_id = p.id
...
// Métodos de pago
$sql_metodos_pago = "SELECT metodo_pago, COUNT(*) as cantidad, COALESCE(SUM(total), 0) as monto
                     FROM ventas WHERE estado='completada'
    ...
    <div class="container-fluid px-4 py-4">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">
                <i class="fas fa-chart-area me-2"></i>Reportes y Estadísticas
            </h1>
            <div>
                <a href="exportar_excel.php?tipo=general" class="btn btn-success">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    <?php echo number_format($total_ventas); ?>
                                </div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    <?php echo formatear_precio($total_ingresos); ?>
                                </div>
                            </div>
                            <div class="col-auto">
            ...
            <div class="col-xl-6">
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex justify-content-between align-items-center">
                        ...
                        <a href="exportar_excel.php?tipo=productos" class="btn btn-sm btn-outline-primary">
                            ...
                            <div class="mt-4">
                                ...
                                ?>
                                    <div class="d-flex align-items-center mb-3 p-2">
                                        <div class="me-3" style="color: <?php echo $info['color']; ?>">
                                            <i class="fas <?php echo $info['icon']; ?> fa-2x"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            <div class="d-flex justify-content-between">
                                                <span class="text-capitalize fw-bold"><?php echo $metodo['metodo_pago']; ?></span>
                                                <span class="fw-bold" style="color: <?php echo $info['color']; ?>">
                                                    <?php echo formatear_precio($metodo['monto']); ?>
                                                </span>
                                            </div>
